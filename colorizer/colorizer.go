...
func DefaultColorizer() *Colorizer {
	return &Colorizer{DefaultScheme()}
}

func (c *Colorizer) ColorizeByType(arg any) string {
	return c.schema.ColorizeByType(arg)
}

func (c *Colorizer) ColorizeByKeys(arg any, keys ...ColorKey) string {
	return c.schema.ColorizeByKeys(arg, keys...)
}
