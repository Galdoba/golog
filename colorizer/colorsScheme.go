...
func defaultColorKey() map[ColorKey]uint8 {
	...
	colMap[fgKey("emergency")] = 15
	colMap[bgKey("emergency")] = 52
	colMap[fgKey("fatal")] = 0
	colMap[bgKey("fatal")] = 88
	colMap[fgKey("alert")] = 88
	colMap[fgKey("critical")] = 88
	colMap[fgKey("error")] = 196
	colMap[fgKey("warning")] = 184
	colMap[fgKey("notice")] = 33
